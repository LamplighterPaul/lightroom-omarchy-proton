# Inherited GE-Proton documentation

Snapshot retained from the fork base, GE-Proton11-7. This describes upstream
GE-Proton; Lightroom setup and project status are in [our README](README.md).
